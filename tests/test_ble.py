...
class TestSesameBleHeader:
    def test_generate_header_only_beginning(self):
    ...
    def test_generate_header_only_plaintext_end(self):
    ...
    def test_generate_header_only_encrypted_end(self):
    ...
    def test_generate_header_beginning_and_plaintext_end(self):
    ...
    def test_generate_header_beginning_and_encrypted_end(self):
    ...
    def test_generate_header_neither_beginning_nor_end(self):
...
class TestSesameWriteGATT:
    @pytest.mark.asyncio
    async def test_write_gatt_without_fragmentation(self, connected_ble_device):
        ble_device, mock_bleak_client = connected_ble_device
    ...
    @pytest.mark.asyncio
    async def test_write_gatt_with_fragmentation(self, connected_ble_device):
        ble_device, mock_bleak_client = connected_ble_device
    ...
    @pytest.mark.asyncio
    async def test_write_gatt_not_connected(self, disconnected_ble_device):
        ble_device, _ = disconnected_ble_device
        with pytest.raises(exc.SesameConnectionError):
...
class TestSesameBleDisconnect:
    @pytest.mark.asyncio
    async def test_disconnect_successful(self, connected_ble_device):
        ble_device, mock_bleak_client = connected_ble_device
    ...
    @pytest.mark.asyncio
    async def test_disconnect_not_connected(self, disconnected_ble_device):
        ble_device, mock_bleak_client = disconnected_ble_device
        await ble_device.disconnect()
...
class TestSesameBleDeviceProperties:
    def test_mac_address(self, mocker: MockerFixture, connected_ble_device):
        ble_device, mock_bleak_client = connected_ble_device
    ...
    def test_is_connected_when_connected(self, connected_ble_device):
        ble_device, _ = connected_ble_device
        assert ble_device.is_connected

    def test_is_connected_when_disconnected(self, disconnected_ble_device):
        ble_device, _ = disconnected_ble_device
